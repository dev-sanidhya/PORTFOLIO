...
export default function SectionHeading({ tag, title, subtitle, light = false }) {
  return (
    ...
    >
      <span className="inline-block text-xs font-mono font-medium tracking-[0.2em] uppercase text-violet-400 mb-3 px-3 py-1 rounded-full border border-violet-500/20 bg-violet-500/8">
        {tag}
      </span>
